👉Questions Covered while Analysis:
...
🌟We want to find out the most popular music Genre for each country. We determine the most popular genre as the genre with the highest count of purchases. 
